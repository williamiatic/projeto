...
INSERT INTO `cidade`(`nm_cidade`,`uf`)
VALUES
('Rio Branco','AC'),
('Maceió','AL'),
('Macapá','AP'),
...
CREATE TABLE `empresa` (
  ...
  KEY `empresa_ibfk_1` (`cidade_id`),
  CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id_cidade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `fornecedor` (
  ...
  KEY `fornecedor_ibfk_1` (`cidade_id`),
  CONSTRAINT `fornecedor_ibfk_1` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id_cidade`),
...
CREATE TABLE `funcionario` (
  ...
  CONSTRAINT `funcionario_ibfk_2` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id_cidade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `loja` (
  ...
  KEY `empresa_id` (`empresa_id`),
  CONSTRAINT `loja_ibfk_1` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id_cidade`),
...
CREATE TABLE `transportadora` (
  ...
  KEY `transportadora_ibfk_1` (`cidade_id`),
  KEY `FK_transportadora` (`empresa_id`),
  CONSTRAINT `FK_transportadora` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id_empresa`),
  CONSTRAINT `transportadora_ibfk_1` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`id_cidade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
